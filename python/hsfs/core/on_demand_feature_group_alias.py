...
# TODO (davit): seems there is some kind of import issue with. identify why?
...
class OnDemandFeatureGroupAlias:
    def __init__(self, on_demand_feature_group, alias):
        self._on_demand_feature_group = hsfs.on_demand_feature_group.OnDemandFeatureGroup.from_response_json(
