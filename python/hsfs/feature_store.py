...
class FeatureStore:
    ...
    def register_inbuilt_transformation_functions(self):
        """Register hsfs inbuilt transformation functions."""
        self._transformation_function_engine.register_inbuilt_transformation_fns()
